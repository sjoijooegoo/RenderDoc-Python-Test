...
class GlobalConfig:
    def __init__(self):
        ...
        self.device_serial = self.get_config('Android', 'device_serial', '')
        ...
        #save
        self.save_dir = self.get_config('path', 'save_dir_abs', os.path.join(self.current_dir, "save"))
        #task
        self.default_task_id = self.get_config('Task', 'default_task_id', 'cmd')
        self.default_task_params = self.get_config('Task', 'default_task_params', '')
